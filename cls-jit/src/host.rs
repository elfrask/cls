...
// ── net eliminado (dev-2) ─────────────────────────────────────────────────────
// El módulo `net` (sockets TCP) se eliminó del runtime. Las features de red
// que lo necesiten deben declararse como `extension` con `when` por SO en
// el .clsx del usuario. Ver docs/lenguaje/extension.md y la guía de
// when+extension.

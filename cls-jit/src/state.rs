...
pub struct HostState {
    ...
    pub(crate) string_caps: std::collections::HashMap<i64, i64>,
    ...
    pub(crate) call_stack: Vec<(String, cls_core::error::diagnostic::Span)>,
    ...
    pub(crate) pending_call_site: Option<cls_core::error::diagnostic::Span>,
    ...
    pub(crate) simple_fn_names: std::collections::HashMap<i64, String>,
    /// Handler del canal `env.host_call` (intrinsics del nodo), si el nodo
    /// registró uno.
    pub(crate) host_call: Option<std::sync::Arc<dyn crate::host::HostCallHandler>>,
}

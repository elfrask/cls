...
static PyObject *__pyx_f_4main_main(void); /*proto*/
...
#define __pyx_n_u_Ejecutable __pyx_string_tab[1]
#define __pyx_n_u_ccls __pyx_string_tab[2]
...
#define __pyx_n_u_print __pyx_string_tab[7]
...
static PyObject *__pyx_f_4main_main(void) {
...
*/
  ...
  __pyx_t_3 = 1;
  {
    PyObject *__pyx_callargs[2] = {__pyx_t_2, __pyx_mstate_global->__pyx_n_u_Ejecutable};
 ...
 * 
*/
  __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_ccls, 0, 0, NULL, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_ccls, __pyx_t_2) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 *     main()
*/
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_name); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = (__Pyx_PyUnicode_Equals(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_main, Py_EQ)); if (unlikely((__pyx_t_3 < 0))) __PYX_ERR(0, 8, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (__pyx_t_3) {
 ...
 *     main()             # <<<<<<<<<<<<<<
*/
    __pyx_t_2 = __pyx_f_4main_main(); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 9, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{10},{4},{18},{8},{10},{8},{5},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 3 && __PYX_LIMITED_VERSION_HEX >= 0x030e0000 /* compression: zstd (80 bytes) */
const char* const cstring = "(\265/\375 ^=\002\000\202\205\017\020\240m\014\242\307\257\231c\265I|U\377\377/`\277P\3677\305,JVa\312\350~\227y\355U\345\372\327\024\tS\377\313\244z4R\350\310\267/\263.\223\006Lch\022\271q\350\t \001\000\006\r3\n";
    PyObject *data = __Pyx_DecompressString(cstring, 80, 3);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (78 bytes) */
const char* const cstring = "x\332%\210\301\r\2000\014\003G\343\305\034V\032\214TH\013\264\311\376\004q\037\237oY\017j\270\024\243\252M\265\332\211\332\341C\224E\364\004\232\344O\332\265\205\361\263.-\367\036\265;\360\204\330\037&}\343.aY\235\323\201\027\360\343%\303";
...
const char* const bytes = "?Ejecutablecclscline_in_traceback__main____module____name__print__qualname__setdefault__test__";
    PyObject *data = NULL;

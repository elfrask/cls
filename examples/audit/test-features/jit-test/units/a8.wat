clx.exe : [JIT] M+¦dulo WASM inv+ílido para 'C:\Users\Frask\AppData\Local\Temp\opencode\a8.clsx':
En línea: 1 Carácter: 196
+ ...  $_.Line }; & "target\debug\clx.exe" run --jit "C:\Users\Frask\AppDat ...
+                 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : NotSpecified: ([JIT] M+¦dulo W...ncode\a8.clsx'::String) [], RemoteException
    + FullyQualifiedErrorId : NativeCommandError
 
WebAssembly translation error

Caused by:
    Invalid input WebAssembly code at offset 1510: type mismatch: expected i64, found f64
--- WAT ---
(module
  ...
  (func (;60;) (type 60) (param i64) (result i64)
    (local i64 i64)
    global.get 0
    local.set 1
    local.get 1
  ...
  (export "main" (func 62))
  (export "alloc" (func 60))
  (export "memory" (memory 0))
  (data (;0;) (i32.const 0) "@\00\00\00\04\00\00\00D\00\00\00\05\00\00\00I\00\00\00\04\00\00\00M\00\00\00\03\00\00\00P\
00\00\00\06\00\00\00V\00\00\00\0a\00\00\00`\00\00\00\0a\00\00\00j\00\00\00\1a\00\00\00abs:sqrt:pow:PI:range:random 
ok:fs.exists:examples/all-features.clsx")
)

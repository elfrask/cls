clx.exe : [JIT] M+¦dulo WASM inv+ílido para 'C:\Users\Frask\AppData\Local\Temp\opencode\b3b.clsx':
En línea: 1 Carácter: 283
+ ... lyContinue; & "target\debug\clx.exe" run --jit "C:\Users\Frask\AppDat ...
+                 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : NotSpecified: ([JIT] M+¦dulo W...code\b3b.clsx'::String) [], RemoteException
    + FullyQualifiedErrorId : NativeCommandError
 
WebAssembly translation error

Caused by:
    Invalid input WebAssembly code at offset 2038: type mismatch: expected i32, found i64
--- WAT ---
(module
